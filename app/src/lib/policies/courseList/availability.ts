...
import type { GroupKey, TermState } from '../../data/termState/types';
...
export function deriveAvailability(state: TermState, entryId: string, meta?: CourseMetaLike): AvailabilityResult {
