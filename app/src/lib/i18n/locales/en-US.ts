export const enUS = {
  settings: {
    ...
    pwaResetCacheLabel: 'Offline cache (Service Worker)',
    pwaResetCacheDesc: 'Fixes “UI not showing after update / stuck on old version” by clearing caches and reloading.',
    pwaResetCacheButton: 'Clear cache & reload',
    aboutSection: 'About',
  ...
  calendar: {
    ...
    sync: {
      ...
      gistDescription: 'Log in, then update/restore the latest cloud snapshot (stores only timestamp + latest state).',
      ...
      confirm: {
        importTitle: 'Confirm restore',
        importBody: 'This will overwrite your local TermState with the latest cloud snapshot. This cannot be undone. Continue?',
        cancel: 'Cancel',
      ...
      statuses: {
        ...
        gistIdRequired: 'No cloud backup yet. Update cloud first.',
        gistImporting: 'Restoring from cloud...',
        gistImportSuccess: 'Restore succeeded: local TermState replaced',
        gistImportDone: 'Restore completed'
      }
    }
  },
  filters: {
